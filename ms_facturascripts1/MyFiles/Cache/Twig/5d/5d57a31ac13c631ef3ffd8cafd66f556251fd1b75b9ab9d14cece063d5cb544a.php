...
class __TwigTemplate_862b7c4ad4f4c0eb4956bc824a48390918f6f5aa0704bc7a7737f4069013eafb extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 39
            echo "        ";
            $this->loadTemplate((($__internal_compile_0 = $context["item"]) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["path"] ?? null) : null), "Master/MenuBghTemplate.html.twig", 39)->display($context);
            // line 40
            echo "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 42
            echo "        ";
            $this->loadTemplate((($__internal_compile_1 = $context["item"]) && is_array($__internal_compile_1) || $__internal_compile_1 instanceof ArrayAccess ? ($__internal_compile_1["path"] ?? null) : null), "Master/MenuBghTemplate.html.twig", 42)->display($context);
            // line 43
            echo "    ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
