...
class __TwigTemplate_8a51eee50062e92f82b9113727a7e9a671975ed7dbee429ff342fbb68ab96daf extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["viewName"] => $context["view"]) {
            ...
            if ((1 === twig_compare(twig_get_attribute($this->env, $this->source, $context["view"], "count", [], "any", false, false, false, 104), 0))) {
                ...
                echo twig_escape_filter($this->env, $this->env->getFunction('number')->getCallable()(twig_get_attribute($this->env, $this->source, $context["view"], "count", [], "any", false, false, false, 105), 0), "html", null, true);
                echo "</span>
                    ";
            }
            // line 107
