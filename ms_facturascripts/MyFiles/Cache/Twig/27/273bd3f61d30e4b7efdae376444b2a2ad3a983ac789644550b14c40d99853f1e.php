...
class __TwigTemplate_9aeb477a915fc4141028fade7e9e22bc4d8444e956898f86c5ff7217442590f4 extends Template
{
    private $source;
    private $macros = [];
...
<script>
    ...
    function salesLineTotalWithTaxes(id) {
        ...
        // line 240
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "total-with-taxes"], "method", false, false, false, 240), "html", null, true);
        echo "').replace(',', '.')) || 0;
    ...
    function salesLineTotalWithoutTaxes(id) {
        const total = parseFloat(prompt('";
        // line 260
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["i18n"] ?? null), "trans", [0 => "net"], "method", false, false, false, 260), "html", null, true);
        echo "').replace(',', '.')) || 0;
        const dtopor = parseFloat(document.forms['salesForm']['dtopor_' + id].value) || 0;
        const dtopor2 = parseFloat(document.forms['salesForm']['dtopor2_' + id].value) || 0;
        const cantidad = parseFloat(document.forms['salesForm']['cantidad_' + id].value) || 0;
...
<form name=\"salesForm\" method=\"post\">
    ...
    <input type=\"hidden\" name=\"columnView\" value=\"";
        // line 370
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["appSettings"] ?? null), "get", [0 => "default", 1 => "columnetosubtotal", 2 => "subtotal"], "method", false, false, false, 370), "html", null, true);
        echo "\"/>
    ";
        // line 371
        echo twig_get_attribute($this->env, $this->source, ($context["fsc"] ?? null), "renderSalesForm", [0 => ($context["model"] ?? null), 1 => twig_get_attribute($this->env, $this->source, ($context["model"] ?? null), "getLines", [], "method", false, false, false, 371)], "method", false, false, false, 371);
        echo "
</form>";
    }
