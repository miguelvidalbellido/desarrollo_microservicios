...
class __TwigTemplate_7a4336bea9d09d76ccf1ddb0e4297ad7dfc06c7114dd65a499e9435809f2e437 extends Template
{
    private $source;
    private $macros = [];
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["currentView"] ?? null), "totalAmounts", [], "any", false, false, false, 185))) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                echo "                            <td class=\"text-right\">
                                ";
                // line 203
                echo twig_escape_filter($this->env, $this->env->getFunction('number')->getCallable()(twig_get_attribute($this->env, $this->source, $context["item"], "page", [], "any", false, false, false, 203)), "html", null, true);
                echo "
                            </td>
                        ";
            }
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                ...
                echo "                            <td class=\"text-right\">
                                ";
                // line 211
                echo twig_escape_filter($this->env, $this->env->getFunction('number')->getCallable()(twig_get_attribute($this->env, $this->source, $context["item"], "total", [], "any", false, false, false, 211)), "html", null, true);
                echo "
                            </td>
                        ";
            }
